		...
		<div class = "container">
			...
			?>
				  <form action="addAccount.php" method="post">
					<p class="mb-2">User Name</p>	<input type="text" name="username">
					<p class="mb-2">Password</p>	<input type="text" name="password">
					<p class="mb-2">Age</p>			<input type="text" name="age">
					<p class="mb-2">Gender</p>		<select id="gender" name="gender">
													<option value = "F">Female</option>
													<option value = "M">Male</option>
													<option value = "U">I Don't want to Check</option>
													</select>
					<p class="mb-2">Country</p>		<select id="country" name="country">';
					
			<?php	$query = "SELECT * FROM Reader_Country;";
					$result = $conn->query($query);
					...
					echo '</select><br><br><button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "create">Create New Account</button></form>';
