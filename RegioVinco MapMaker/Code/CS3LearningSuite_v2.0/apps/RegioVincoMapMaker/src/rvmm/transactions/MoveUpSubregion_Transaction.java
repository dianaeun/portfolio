 ...
 * @author DayeE
 */
public class MoveUpSubregion_Transaction implements jTPS_Transaction {
    
    MapMakerData data;
    SubregionPrototype itemToMove;
    
    public MoveUpSubregion_Transaction(MapMakerData initData, SubregionPrototype initItemToMove) {
        data = initData;
