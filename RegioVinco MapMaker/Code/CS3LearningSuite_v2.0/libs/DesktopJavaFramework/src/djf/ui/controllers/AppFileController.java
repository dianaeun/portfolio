...
//            File workFile = dC.showDialog(app.getGUIModule().getWindow());
            app.getFileComponent().exportData(app.getDataComponent(), workFileName);
            AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), EXPORT_SUCCESS_TITLE, EXPORT_SUCCESS_CONTENT);
///            AppDialogsFacade.showExportDialog(app);
	...
	// BEEN SAVED AT LEAST ONCE
        ...
        ButtonType selection = AppDialogsFacade.showYesNoDialog(app.getGUIModule().getWindow(), SAVE_VERIFY_TITLE, SAVE_VERIFY_CONTENT);
