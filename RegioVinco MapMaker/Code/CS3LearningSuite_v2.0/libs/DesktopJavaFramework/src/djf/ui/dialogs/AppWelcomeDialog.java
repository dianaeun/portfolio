...
import static djf.AppPropertyType.WELCOME_DIALOG_NEW_BUTTON;
...
public class AppWelcomeDialog extends Stage {
    ...
    public AppWelcomeDialog(AppTemplate app) {
        ...
        if(recentWorkButtons.isEmpty()) {
            recentlyEditedPane.getChildren().add(new Label("None"));
        }
        ...
        createNewButton.setOnAction(e->{
            this.hide();
            app.getWorkspaceComponent().openNewDialog();
            app.getGUIModule().getWindow().show();
